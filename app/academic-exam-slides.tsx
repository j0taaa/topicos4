...
const examQuestions: ExamQuestion[] = [
  ...
  {
    id: "17",
    title: "Exclusão mútua e interrupções",
    prompt: "Avalie as duas asserções e a relação entre elas.",
    statements: [
      "I. Em algumas situações, o sistema operacional pode obter exclusão mútua desabilitando interrupções; esse controle não deve ser entregue ao usuário.",
      "II. Essa técnica é mais eficiente em multiprocessadores, devido ao maior número de processos concorrentes.",
    ],
    alternatives: [
    ...
    answer: "C",
    answerLabel: "I verdadeira; II falsa",
    reasoning: [
      "Desabilitar interrupções impede preempção naquele processador durante uma seção crítica curta.",
      "A operação é privilegiada: um processo de usuário poderia congelar o sistema se controlasse interrupções livremente.",
      "Em multiprocessadores, desabilitar interrupções em uma CPU não impede outra CPU de acessar o mesmo estado.",
      "Locks e primitivas atômicas continuam necessários para exclusão entre múltiplos cores.",
    ],
    connection: "Virtualização precisa mediar operações privilegiadas; o guest não recebe controle irrestrito sobre a máquina física.",
  },
  {
    id: "25",
